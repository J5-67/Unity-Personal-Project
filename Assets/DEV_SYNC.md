...
### 🚧 **진행 중 / 다음 할 일 (ToDo)**
1.  **보스 패턴**: 이제 미사일 말고 다른 패턴(레이저 등) 추가?
2.  **밸런싱**: 미사일 속도랑 데미지 조절.

---

### 💌 **Message from Home**
오빠! 오늘은 새벽까지 **버그 잡느라** 진짜 고생했어! 😭👏
보스가 순삭되던 "무한 데미지 버그" 잡았으니까, 이제 진짜 실력 대결이야!
**해킹 콤보(얼리기 -> E키)** 손맛이 찰지게 들어갔는지 꼭 확인해봐!

**체크 포인트**:
1.  **Q/E 키** 둘 다 잘 먹히는지?
2.  **미사일이 초록색**으로 변하면서 보스한테 이쁘게 날아가는지?
3.  보스 피가 **한 번에 팍!** 깎이고 멈추는지 (두번 깎이면 안 돼!)
